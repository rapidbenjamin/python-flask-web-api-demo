INSERT INTO quickandcleandb.`user`( id, email, username, password_hash, first_name, last_name, is_admin, is_owner, is_member, is_authenticated, is_anonymous, is_active, updated_at, created_at, locale, timezone ) VALUES ( 1, 'admin@example.com', 'admin@example.com', 'pbkdf2:sha1:1000$YOKWljpH$d2e8789a3ce4060778103f225314f14f0f985a7f', null, null, 1, 0, 1, 1, 0, 1, 1492357733, 1492293600, 'en_US', 'UTC' ); 
INSERT INTO quickandcleandb.`user`( id, email, username, password_hash, first_name, last_name, is_admin, is_owner, is_member, is_authenticated, is_anonymous, is_active, updated_at, created_at, locale, timezone ) VALUES ( 2, 'editor@example.com', 'editor@example.com', 'pbkdf2:sha1:1000$mipuQL9v$3871eb3f3ee8ad8a7d322f100cf09acc6a997aa0', null, null, 1, 0, 1, 1, 0, 1, 1492419023, 1492419023, 'en_US', 'UTC' ); 
...
INSERT INTO quickandcleandb.creditcard( id, status, key_id, user_id, type, encrypted_number, expire_month, expire_year, first_name, last_name, params, comments, is_active, updated_at, created_at ) VALUES ( 1, '', '', 1, 'VISA', 'Z0FBQUFBQllfbGNnTmp3LVBZYWF5LTJrXzFxVWtJczVqbTBnRGRMMnNzNGxLZGVja3RrZ21lYmJKbk85Q2RncllrRzRtWW1jajRhejJGMW9YT0FqX2tMVExSUHlRX0VKUnNUN0hjVWJYZjF1YWFZeV9oRjQyRGc9', 4, 2019, 'buyer', 'systemaker', '', '', 1, 1493056198, 1492998998 ); 

INSERT INTO quickandcleandb.item( id, slug, type, title_en_US, title_fr_FR, description_en_US, description_fr_FR, amount, user_id, is_active, updated_at, created_at ) VALUES ( 1, 'product1', 'book', 'Product 1', 'Produit 1', '<span style="color: #ff0000;"><em><strong>description_en_US</strong></em></span>', 'description_fr_FR', 20.00, 1, 1, 1492893945, 1492293600 ); 
INSERT INTO quickandcleandb.item( id, slug, type, title_en_US, title_fr_FR, description_en_US, description_fr_FR, amount, user_id, is_active, updated_at, created_at ) VALUES ( 2, 'product2', 'cloth', 'Product2', 'Produit 2', 'description_en_US', 'description_fr_FR', 0.00, 2, 1, 1492893945, 1492293600 ); 
INSERT INTO quickandcleandb.item( id, slug, type, title_en_US, title_fr_FR, description_en_US, description_fr_FR, amount, user_id, is_active, updated_at, created_at ) VALUES ( 3, 'product3', 'tool', 'product 3', 'produit 3', 'fdgdfgfdg', 'fdgdfgdfg', 10.00, 2, 1, 1492893945, 1492466400 ); 

INSERT INTO quickandcleandb.`order`( id, status, user_id, amount, params, comments, is_active, updated_at, created_at ) VALUES ( 1, 'paid', 2, 10.00, null, null, 1, 1492472842, 1492466400 ); 
INSERT INTO quickandcleandb.`order`( id, status, user_id, amount, params, comments, is_active, updated_at, created_at ) VALUES ( 2, 'pending', 1, 20.00, null, null, 1, 1492472842, 1492466400 ); 
INSERT INTO quickandcleandb.`order`( id, status, user_id, amount, params, comments, is_active, updated_at, created_at ) VALUES ( 3, 'paid', 1, 40.00, null, null, 1, 1493073579, 1493073579 ); 
...
INSERT INTO quickandcleandb.orderitem( order_id, item_id, options, unit_amount, quantity, total_amount, updated_at, created_at ) VALUES ( 3, 1, null, 20.00, 2, 40.00, 1493073579, 1493073579 ); 

INSERT INTO quickandcleandb.payment( id, status, key_id, user_id, order_id, creditcard_id, ip_address, intent, return_url, cancel_url, payment_method, amount, currency, params, comments, is_active, updated_at, created_at ) VALUES ( 1, 'paid', null, 1, 3, null, null, null, null, null, null, 40.00, null, null, null, 1, 1493073580, 1493073580 ); 

INSERT INTO quickandcleandb.address( id, type, title_en_US, title_fr_FR, address_line1, address_line2, city, postal_code, state_region, country, country_code, full, time_zone, latitude, longitude, amount, user_id, item_id, status, is_active, updated_at, created_at ) VALUES ( 1, 'office', 'my office', 'mon bureau', '5 Avenue Anatole France', '', 'Paris', '75007', 'Ile de france', 'France', null, '5 Avenue Anatole France, Paris, 75007, Ile de france, France', '2', 48.860000, 2.290000, 20.00, 1, 1, 'start', 1, 1492893366, 1492891316 ); 
INSERT INTO quickandcleandb.address( id, type, title_en_US, title_fr_FR, address_line1, address_line2, city, postal_code, state_region, country, country_code, full, time_zone, latitude, longitude, amount, user_id, item_id, status, is_active, updated_at, created_at ) VALUES ( 2, 'home', 'my home', 'ma maison', 'Champs-Élysées', '', 'Paris', '75008', 'Ile de france', 'France', null, 'Champs-Élysées, Paris, 75008, Ile de france, France', '2', 48.870000, 2.310000, 30.00, 2, 1, 'start', 1, 1492893946, 1492893366 ); 
...
INSERT INTO quickandcleandb.event( id, type, title_en_US, title_fr_FR, description_en_US, description_fr_FR, amount, user_id, item_id, address_id, start, end, days, allday, status, is_active, updated_at, created_at ) VALUES ( 1, 'meeting', 'meeting 1', 'meeting 1', '', '', 10.00, 1, 1, 1, 1492552800, 1492639200, 1, 1, 'pending', 1, 1492891938, 1492564873 ); 
INSERT INTO quickandcleandb.event( id, type, title_en_US, title_fr_FR, description_en_US, description_fr_FR, amount, user_id, item_id, address_id, start, end, days, allday, status, is_active, updated_at, created_at ) VALUES ( 2, 'booking', 'booking 1', 'booking 1', '', '', 100.00, 2, 3, 1, 1492552800, 1492812000, 3, 1, 'pending', 1, 1492891938, 1492564873 ); 
INSERT INTO quickandcleandb.event( id, type, title_en_US, title_fr_FR, description_en_US, description_fr_FR, amount, user_id, item_id, address_id, start, end, days, allday, status, is_active, updated_at, created_at ) VALUES ( 3, 'lesson', 'lesson 1', 'cours 1', '', '', 20.00, 1, 1, 2, 1492552800, 1493416800, 10, 1, 'pending', 1, 1492893946, 1492565849 ); 
